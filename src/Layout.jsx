  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-slate-900 to-gray-900">
      ...
      <div className="bg-black/40 backdrop-blur-xl border-b border-white/10 sticky top-0 z-50">
        ...
        <div className="bg-slate-50 text-slate-950 mx-6 px-6 rounded-[10px] hidden lg:flex border-t border-white/10 items-center">
          {navItems.map((item) =>
          <Link
            key={item.name}
            to={item.path}
          ...
          <div className="ml-auto flex items-center gap-3">
            ...
            <div className="flex items-center gap-2 px-3 py-2 rounded-lg bg-emerald-50 border border-emerald-200">
              ...
              <span className="text-xs font-medium text-slate-900">All systems online</span>
            </div>

            {/* M.POS Connected */}
            <div className="flex items-center gap-2 px-3 py-2 rounded-lg bg-blue-50 border border-blue-200">
              <Wifi className="w-3.5 h-3.5 text-blue-600" />
              <span className="text-xs font-medium text-slate-900">M.POS connected</span>
            </div>
          </div>
        </div>
      </div>
